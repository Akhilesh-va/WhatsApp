...
fun UserRegistrationScreen() {
    ...
    Column(
        ...
        Row {
            ...
            Text(text = "What's", color = colorResource(R.color.whatsapp_medium_green))
        }
        Row {

            Text(text = "my number?", color = colorResource(R.color.whatsapp_medium_green))
        }
        ...
        DropdownMenu(
            ...
            listOf(
                ...
                DropdownMenuItem(
                    text = {
                        Text(
                            text = country, style = TextStyle(fontSize = 16.sp, color = Color.Black)
                        )
                    }, onClick = {
